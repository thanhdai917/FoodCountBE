...
<head>
  ...
  <link rel="icon" href="http://daict.name.vn/wp-content/uploads/2020/09/cropped-flatsome-menu-2.jpg">
...
<body class="bg-gradient-primary">
  ...
  <script src="<?= BASEURL ?>/public/js/checkuser.js"></script>
  <script src="<?= BASEURL ?>/public/js/password.js"></script>
